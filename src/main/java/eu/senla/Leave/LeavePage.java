...
public class LeavePage {
  private final SelenideElement leaveModuleLink =
      $x("//a[@href='/web/index.php/leave/viewLeaveModule']");
  private final SelenideElement assignLeaveMenu =
      $x("//a[@class='oxd-topbar-body-nav-tab-item'][text()='Assign Leave']");
  private final SelenideElement leaveTitle =
      $x("//p[@class='oxd-text oxd-text--p orangehrm-main-title']");
